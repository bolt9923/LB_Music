...
import config
from BrandXMusic.utils.formatters import time_to_seconds
...
def stream_markup_timer(_, vidid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="Support 📞", url=f"https://t.me/+7jH9qwaLWPsxNWNl"
            ),
            InlineKeyboardButton(
                text="Update 🔔", url=f"https://t.me/YOUTUBE_RROBOT_UPDATES"
            ),
        ],
